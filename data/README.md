...
<!-- Point this at wherever the PNG actually lives in the repo (e.g. report/figures/...). -->
![Lake Mead near-shore: standard k-means stretches one cluster across the water; the obstacle-aware version pulls it onto a single arm](figures/mead_near_three_methods.png)

> 📊 **[Interactive dashboard — Lake Mead near-shore case](https://www.arcgis.com/REPLACE_WITH_YOUR_DASHBOARD_URL)** (ArcGIS Online)
...
<!-- Module descriptions above are my best guess from the names — adjust to match what each file actually does. -->
...
Released under the [MIT License](LICENSE). <!-- Adjust to your choice. -->
